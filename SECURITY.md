...
Energy-Grid-Protector is a **scanning/detection tool**, not a versioned service. The latest commit on `main` is always the supported version.
...
1. Open a [GitHub private security advisory](https://github.com/spinfosecurity/Energy-Grid-Protector/security/advisories/new)
...
This tool is intended **exclusively for authorized security assessments** of power grid and substation OT/SCADA environments. Unauthorized scanning is illegal and outside the intended use of this software.
